    ...
    descriptions = {
        Mod = {
            JokerDisplay = {
                name = "JokerDisplay",
                text = {
                    "Geeft handige informatie weer onder Jokers",
                    " ",
                    "{C:attention}Besturing:{}",
                    "{C:blue}Rechter-muisknop of B:{} verbergen/tonen",
                    "{C:blue}Linker-muisknop of pijl omhoog:{} inklappen/uitklappen",
                    " ",
